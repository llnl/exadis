...
struct MobilityBCC_nl
{
    ...
    void FscaleEdge(const System* system, double vin, const Vec3& burg,
                    double& fout, double& dfdv, double& dfdvlin) const
    {
    ...
    KOKKOS_INLINE_FUNCTION
    void FscaleScrew(const System* system, double vin, double psi, const Vec3& burg,
                     double& fout, double& dfdv, double& dfdvlin, double& dfdpsi) const
    {
    ...
    void ScrewDrag(const System* system, Vec3& vel, const Vec3& burg,
                   const double tdotb, Vec3& fsdrag, Mat33& dfsdragdv) const
    {
        double eps = 1.0e-12;
        double bnorm = burg.norm();

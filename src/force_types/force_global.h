...
#define X(TYPE, ALIAS) \
    template<> inline ForceGlobal::ALIAS& ForceGlobal::get<ForceGlobal::ALIAS>() { return force_##ALIAS; } \
    template<> inline const ForceGlobal::ALIAS& ForceGlobal::get<ForceGlobal::ALIAS>() const { return force_##ALIAS; }
    EXADIS_FORCE_GLOBAL_LIST
#undef X
